...
class SVT(nn.Module):
    def __init__(self,
                 ...
                 sr_ratios=[4, 2, 1, 1],
                 num_stages=4,
                 token_label=True, # set it False when you achieve classification tasks
                 **kwargs
                 ):
        super().__init__()
...
@register_model
def svt_s(pretrained=False, num_classes=1000, **kwargs):
    model = SVT(
...
@register_model
def svt_b(pretrained=False, num_classes=1000, **kwargs):
    model = SVT(
        num_classes=num_classes,
        stem_hidden_dim=64,
...
@register_model
def svt_l(pretrained=False, num_classes=1000, **kwargs):
    model = SVT(
        num_classes=num_classes,
        stem_hidden_dim=64,
